...
const CreatePost=()=>{
  ...
  const createPost=async(e)=>{
    ...
    if(post==false){
      ...
      axios.post(process.env.REACT_APP_PROXY_URL+''+process.env.REACT_APP_API_CREATE_POST, 
      {
        image:pImage==null ? selectedImage : pImage,
        title:title,
        content:content,
        description:desc,
        tags:tag
      ...
      <AdminContent>
        ...
        <form method="POST" onSubmit={createPost}>
          ...
          <div className="SettingsFormGroup">
            ...
            <input type="text" ref={smallImage} value={pImage} onChange={(e)=>setPImage(e.target.value)} placeholder="https:a" />
